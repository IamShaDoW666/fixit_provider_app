...
import 'package:handyman_provider_flutter/components/booking_detail_image_component.dart';
            ...
            children: [
              AnimatedScrollView(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 16),
                    child: BookingDetailImageComponent(
                        imageList: res.data!.bookingDetail!.bookingAttachments),
                  ),
                  Divider(height: 0, color: context.dividerColor),
